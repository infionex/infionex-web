...
export default function Hero() {
    return (
        <div className='relative h-screen px-10 md:px-24 content-center text-white  bg-[linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(\src\assets\images\hero-bg.jpg)] bg-center bg-cover'>
