  ...
  return (
    <div className=''>
      ...
      <div className='bg-secondary-color/80 z-30 fixed text-white w-screen flex justify-between px-10 py-3 items-center drop-shadow-lg drop-shadow-black'>
        ...
        {/* navbar */}
   <div className='max-w-425 mx-auto w-full flex justify-between items-center'>
        <div className='flex'>
        ...
        <div className='font-head flex items-center gap-3'>
          <button className='bg-primary-color px-3 py-1.5 text-black font-bold rounded-md'>LET'S TALK</button>
